...
R60Y3r = Y3random(60);
save('R60Y3r.mat','R60Y3r','-mat');
R70Y3r = Y3random(70);
save('R70Y3r.mat','R70Y3r','-mat');
R90Y3r = Y3random(90);
save('R90Y3r.mat','R90Y3r','-mat');
R100Y3r = Y3random(100);
save('R100Y3r.mat','R100Y3r','-mat');
...
% R60Y3c = Y3cyclic(60);
% save('R60Y3c.mat','R60Y3c','-mat');
% R70Y3c = Y3cyclic(70);
% save('R70Y3c.mat','R70Y3c','-mat');
% R90Y3c = Y3cyclic(90);
% save('R90Y3c.mat','R90Y3c','-mat');
% R100Y3c = Y3cyclic(100);
% save('R100Y3c.mat','R100Y3c','-mat');
